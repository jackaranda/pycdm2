"""
Implements the "Claris" ASCII data format Variable and Dataset subclasses.  This variation
attempts to open all files in a directory and combines the data from all compatible files
into a single resultant dataset.  The code also attempts to find a meta-data file containing
station latitudes, longitude, altitudes, and full names.  It is possible to pass meta-data 
to the constructor as a dictionary, a file path, or an open file handle.
